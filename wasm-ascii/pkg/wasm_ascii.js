 ...
 * @returns {string}
 */
export function generate_text_in_center(text, width, height) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.generate_text_in_center(retptr, ptr0, len0, width, height);
 ...
 * @returns {string}
 */
export function generate_sphere_frame(angle) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.generate_sphere_frame(retptr, angle);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {Uint32Array}
 */
export function get_image_dimensions(image_data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function compress_image(image_data, max_width, quality, format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(image_data, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        ...
        wasm.compress_image(retptr, ptr0, len0, max_width, quality, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @param {string} manual_char
 * @param {boolean} ignore_white
 * @param {boolean} dithering
 * @param {string} dither_algorithm
 * @param {string} edge_method
 * @param {number} edge_threshold
 * @param {number} dog_threshold
 * @param {number} brightness
 * @param {number} contrast
 * @returns {string}
 */
export function convert_to_ascii(data, width, height, invert, charset, manual_char, ignore_white, dithering, dither_algorithm, edge_method, edge_threshold, dog_threshold, brightness, contrast) {
    let deferred6_0;
    let deferred6_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(charset, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(manual_char, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(dither_algorithm, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(edge_method, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len4 = WASM_VECTOR_LEN;
        wasm.convert_to_ascii(retptr, ptr0, len0, width, height, invert, ptr1, len1, ptr2, len2, ignore_white, dithering, ptr3, len3, ptr4, len4, edge_threshold, dog_threshold, brightness, contrast);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred6_0 = r0;
        deferred6_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_ascii_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
